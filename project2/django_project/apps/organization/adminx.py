...
class CourseOrgAdmin(object):
    ...
    search_fields = ['name', 'desc', 'click_nums', 'fav_nums', 'address', 'city', 'add_time']
...
class TeacherAdmin(object):
    ...
    search_fields = ['org', 'name', 'work_years', 'work_company', 'work_position', 'points', 'click_nums', 'add_time']
